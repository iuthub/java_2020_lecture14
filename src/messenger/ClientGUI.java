...
{   
   ...
   private messenger.MessageManager messageManager; // communicates with server
   private messenger.MessageListener messageListener; // receives incoming messages
 
   // ClientGUI constructor
   public ClientGUI( messenger.MessageManager manager )
   {       
   ...
   private class MyMessageListener implements messenger.MessageListener
   {
